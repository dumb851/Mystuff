...
//                            .setAction("Action", null).show();
                    ...
                    Intent intent = ItemPagerActivity.newIntent(getApplicationContext(), null);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        getMyActionBar().setSubtitle("");
        FragmentManager fragmentManager = getSupportFragmentManager();

        if (id == R.id.nav_items) {

            Fragment fragment = ItemsListFragment.newInstance();
            ...
            getMyActionBar().setSubtitle(R.string.subtitle_labels);
